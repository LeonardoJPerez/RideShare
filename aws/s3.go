...
// CloudName prepends the given string with 'viro-'
func (s *Service) CloudName(env string) string {
...
func (s *Service) ListBuckets(bucketName string) ([]string, error) {
	bucketName = s.CloudName(bucketName)
...
func (s *Service) ListObjects(bucketName string) ([]string, error) {
	bucketName = s.CloudName(bucketName)
	svc := s3.New(s.session)
...
func (s *Service) Validate(bucketName string) (bool, error) {
